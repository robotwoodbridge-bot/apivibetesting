...
// In-memory orders store keyed by userId
const orderStore = {};
 ...
 *         description: Unauthorized
 */
// BUG B5: Expired card expiry dates are accepted — no date validation
router.post('/', authenticate, (req, res) => {
  ...
  // BUG B5: expiry date is formatted correctly but never checked against today's date
  // A card with expiryDate "01/20" (year 2020) passes validation
